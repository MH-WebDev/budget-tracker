...
export const user_data = pgTable(
  "user_data",
  {
    ...
    account_created_timestamp: timestamp("account_created_timestamp")
      .defaultNow()
      .notNull(),
    preferred_currency: varchar("preferred_currency").default("USD").notNull(),
    preferred_currency_symbol: varchar("preferred_currency_symbol")
      .default("$")
      .notNull(),
    selected_date_format: varchar("selected_date_format")
      .default("MM/dd/yyyy")
      .notNull(),
...
export const budget_data = pgTable(
  "budget_data",
  {
    id: serial().primaryKey(),
    user_id: varchar("user_id", { length: 255 })
      .references(() => user_data.user_id, { onDelete: "cascade" })
      .notNull(),
    budget_name: varchar("budget_name", { length: 30 }).notNull(),
    amount: numeric("amount").notNull(),
    icon: varchar().default("💸"),
    status: varchar("status").default("active").notNull(),
    budget_created_timestamp: timestamp("budget_created_timestamp")
      .defaultNow()
      .notNull(),
    updated_at: timestamp("updated_at").defaultNow().notNull(),
  },
...
export const expense_data = pgTable(
  "expense_data",
  {
    id: serial().primaryKey(),
    user_id: varchar("user_id", { length: 255 })
    ...
    amount: numeric("amount").notNull(),
    budget_id: integer()
      .references(() => budget_data.id, { onDelete: "cascade" })
      .notNull(),
    category: varchar().notNull(),
    icon: varchar().default("💸"),
    description: varchar(),
    expense_created_timestamp: timestamp("expense_created_timestamp")
      .defaultNow()
      .notNull(),
    updated_at: timestamp("updated_at").defaultNow().notNull(),
  },
...
export const income_data = pgTable(
  "income_data",
  {
    id: serial().primaryKey(),
    user_id: varchar("user_id", { length: 255 })
    ...
    icon: varchar().default("💸"),
    comment: varchar(),
    income_created_timestamp: timestamp("income_created_timestamp")
      .defaultNow()
      .notNull(),
    updated_at: timestamp("updated_at").defaultNow().notNull(),
  },
